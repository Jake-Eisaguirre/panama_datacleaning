...
librarian::shelf(tidyverse, here, janitor, lubridate, parsedate, naniar)
...
#survey table unique relationship is the date and survey_time
...
write.csv(site_data, here("data", "site_table.csv"))
...
```{r}
# `sort_id` is the unique id and the unique relationship is in the date and detection type
